...
public class Lexer {
    ...
    public Lexer(String data) {
        ...
        map.put(Pattern.compile("([a-z][a-zA-Z]*).*"), Terminal.NAME);
        map.put(Pattern.compile("(,).*"), Terminal.COMA);
        ...
        map.put(Pattern.compile("(\\().*"), Terminal.LB);
        map.put(Pattern.compile("(\\)).*"), Terminal.RB);
